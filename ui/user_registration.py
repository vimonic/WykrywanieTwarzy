...
class UserRegistration(QMainWindow):
    # Signal emitted after registration completion
    registration_complete = pyqtSignal()

    def __init__(self):
        super().__init__()
        self.setWindowTitle('Face Access - Rejestracja Użytkownika')
        self.resize(900, 700)
        ...
        # UI elements
        title = QLabel('Rejestracja Użytkownika')
        ...
        # Status label
        self.status_label = QLabel('Podaj nazwę użytkownika i rozpocznij rejestrację')
    ...
    def start_registration(self):
        text, ok = QInputDialog.getText(self, "Rejestracja Użytkownika",
    ...
    def update_frame(self):
        ...
        if len(faces) > 0:
            ...
            if self.registration_mode and self.ready_to_capture:
                ...
                # Pierwsza próbka tworzy nowego użytkownika z rolą 'USER'
